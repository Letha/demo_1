...
Сайт проекта: http://s7478147.beget.tech/</br>
Для установки проекта локально - загрузить зависимости через Composer.</br>
...
Мультиязычность.</br>
Функционал приложения: формы регистрации/авторизации с возможностью загрузки изображения (кнопки открытия форм сверху справа), отображение профиля пользователя.</br>
...
- Индикаторы ожидания ответа сервера.</br>
JavaScript:
...
## Примечания
Комментарии к коду есть в основном на back-end'e (для экономии времени).</br>
Есть дамп базы данных {/db-dumps} (демонстрирует её структуру).</br>
Мuli-unit тест (в проекте такие есть) - это единый тест для тестирования нескольких классов, имеющих единый интерфейс.</br>
